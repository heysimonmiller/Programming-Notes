...
Can do 3 things to the DOM:

Manipulation - where we manipulate elements
~~~~~~~~~~~~

Traversal - selecting an element based on the relationship with another element - e.g. selecting a child element from a known parent element.
~~~~~~~~~ - like selecting a <li> from a <ul>.

Events - listenining to specific events like mouse click or key presses and having something to execute.
~~~~~~


Inbuilt Objects

window – gives you access to information about the current browser window. Including its document, location and the global scope.
document – gives you access to all HTML nodes.
The syntax for accessing a property is object.property
The syntax for calling a method on an object is object.methodName().
...
--------------------------------------
                                                            ...
                                                            -----------------------------
                                                              The 4 P's of Programming'
                                                            -----------------------------
-------------------------------------------------------------------------------------------------------------------------------
Preparation - where we understand the problem and think of a high level solution
~~~~~~~~~~~~
//Problem: User interaction doesn't provide desired results.
//Solution: Add interactivitiy so the user can manage daily tasks.


-------------------------------------------------------------------------------------------------------------------------------
Plan - where we plan out the solution
~~~~
//Add a new task
...
-------------------------------------------------------------------------------------------------------------------------------
Perform - where we perform what is required. //var addTask = function() {} is the same as function addTask() {}
~~~~~~~
...
var taskInput = document.getElementById("new-task"); //new-task //don't need to put ("#new-task") because it's already looking for an Id.
...
-------------------------------------------------------------------------------------------------------------------------------
Perfect where we perfect the solution. //can also add - stopping you from adding empty tasks and change "edit" button's text when you're in editing mode.
~~~~~~~
//Problem: User interaction doesn't provide desired results.
//Solution: Add interactivitiy so the user can manage daily tasks.
...
var addTask = function() {
  ...
  taskInput.value = ""; //clears the task input when you press "Add"
}
...
//Set the click handler to the addTask function
addButton.addEventListener("click", addTask); // better way to add an event listener as you can add multiple ones (not just one that gets overwritten)
